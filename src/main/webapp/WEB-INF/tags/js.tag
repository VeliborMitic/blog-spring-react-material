...
<script>
    var _csrf = {header: '${_csrf.headerName}', name: '${_csrf.parameterName}', token: '${_csrf.token}'};
</script>
<script type="text/javascript" src="<c:url value="/webjars/jquery/2.1.4/dist/jquery.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="/webjars/materialize/0.97.6/dist/js/materialize.min.js"/>"></script>
